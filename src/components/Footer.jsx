...
const Footer = () => {
  return (
    <footer className="px-4 divide-y dark:bg-gray-800 dark:text-gray-800">
      <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
        <div className="lg:w-1/3">
          ...
          >
            <div className="flex items-center justify-center rounded-full">
              <img className="w-[80px]" src={Papaya} alt="" />
            </div>
            <span className="self-center text-2xl font-semibold text-indigo-700">
              HobbyHub
            </span>
          </a>
        </div>
        <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
          <div className="space-y-3">
            <h3 className="tracking-wide uppercase dark:text-gray-200">
              Product
            </h3>
